(function () {
    ...
    /* @ngInject */
    function myCalendarController($scope, $mdDialog, $mdToast, $timeout, pageService, toaster, $stateParams, $state, CONFIG, userService, myCalendarService, activityService, adminUserService) {
